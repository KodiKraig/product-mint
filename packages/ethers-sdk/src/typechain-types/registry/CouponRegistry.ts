...
export interface CouponRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "createCoupon"
      | "discountedAmount"
...
export interface CouponRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): CouponRegistry;
  waitForDeployment(): Promise<this>;

  interface: CouponRegistryInterface;
