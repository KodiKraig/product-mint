...
export interface IPurchaseRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getPassProductIds"
...
export interface IPurchaseRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): IPurchaseRegistry;
  waitForDeployment(): Promise<this>;

  interface: IPurchaseRegistryInterface;
  ...
  isWhitelist: TypedContractMethod<
    [organizationId: BigNumberish],
    [boolean],
    "view"
  >;

  maxMints: TypedContractMethod<
    [organizationId: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  passOrganization: TypedContractMethod<
    [tokenId: BigNumberish],
    [bigint],
    "view"
  >;

  productMaxSupply: TypedContractMethod<
    [productId: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  totalPassMints: TypedContractMethod<
    [organizationId: BigNumberish],
    [bigint],
    "view"
  >;
