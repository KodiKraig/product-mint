...
export interface IDiscountRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IDiscountRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): IDiscountRegistry;
  waitForDeployment(): Promise<this>;

  interface: IDiscountRegistryInterface;
  ...
  discountNames: TypedContractMethod<
    [orgId: BigNumberish, name: string],
    [bigint],
    "view"
  >;
  ...
  ): TypedContractMethod<[orgId: BigNumberish, name: string], [bigint], "view">;
  getFunction(
