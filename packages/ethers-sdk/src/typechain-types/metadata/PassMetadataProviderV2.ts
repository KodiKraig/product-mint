...
export interface PassMetadataProviderV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "attributeProvider"
...
export interface PassMetadataProviderV2 extends BaseContract {
  connect(runner?: ContractRunner | null): PassMetadataProviderV2;
  waitForDeployment(): Promise<this>;

  interface: PassMetadataProviderV2Interface;
