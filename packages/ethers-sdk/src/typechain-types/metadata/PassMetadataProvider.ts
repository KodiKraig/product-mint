...
export interface PassMetadataProviderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "attributeProvider"
...
export interface PassMetadataProvider extends BaseContract {
  connect(runner?: ContractRunner | null): PassMetadataProvider;
  waitForDeployment(): Promise<this>;

  interface: PassMetadataProviderInterface;
