...
export interface IPermissionFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IPermissionFactory extends BaseContract {
  connect(runner?: ContractRunner | null): IPermissionFactory;
  waitForDeployment(): Promise<this>;

  interface: IPermissionFactoryInterface;
