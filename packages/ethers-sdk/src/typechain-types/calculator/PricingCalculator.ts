...
export interface PricingCalculatorInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PricingCalculator extends BaseContract {
  connect(runner?: ContractRunner | null): PricingCalculator;
