...
import type {
  IProductRegistry,
  IProductRegistryInterface,
} from "../../registry/IProductRegistry";
...
export class IProductRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): IProductRegistryInterface {
    return new Interface(_abi) as IProductRegistryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IProductRegistry {
    return new Contract(address, _abi, runner) as unknown as IProductRegistry;
  }
}
