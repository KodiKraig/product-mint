...
import type {
  IPricingRegistry,
  IPricingRegistryInterface,
} from "../../registry/IPricingRegistry";
...
export class IPricingRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): IPricingRegistryInterface {
    return new Interface(_abi) as IPricingRegistryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IPricingRegistry {
    return new Contract(address, _abi, runner) as unknown as IPricingRegistry;
  }
}
