...
export interface IOrganizationAdminInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addAdmin"
      | "getAdmins"
...
export interface IOrganizationAdmin extends BaseContract {
  connect(runner?: ContractRunner | null): IOrganizationAdmin;
  waitForDeployment(): Promise<this>;

  interface: IOrganizationAdminInterface;
