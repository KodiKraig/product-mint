import {
  DynamicPriceRegistryUpdated as DynamicPriceRegistryUpdatedEvent,
...
export function handleDynamicPriceRegistryUpdated(
  event: DynamicPriceRegistryUpdatedEvent,
): void {
  let entity = new DynamicPriceRegistryUpdated(
    event.transaction.hash.concatI32(event.logIndex.toI32()),
  )
  entity._dynamicPriceRegistry = event.params._dynamicPriceRegistry
