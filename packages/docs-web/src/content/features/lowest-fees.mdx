...
ProductMint offers the lowest fees in the industry even across traditional payment processors along with micro-payment support. Fees are collected on each transaction when a Product Pass is minted or a subscription is renewed/upgraded.
