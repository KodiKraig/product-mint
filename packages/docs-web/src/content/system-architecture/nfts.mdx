...
Only the wallet that holds the Organization NFT has the ability to withdraw revenue from the escrow system. If you lose access to the wallet that holds the Organization NFT, you will not be able to withdraw your revenue.
</Callout>
