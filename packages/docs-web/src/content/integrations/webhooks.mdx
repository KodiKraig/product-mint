...
Webhooks are a great way to notify you when certain events happen in the ProductMint ecosystem. They are powered by events emitted from the contracts. You can listen to the events directly with a web3 provider such as [Alchemy](https://www.alchemy.com/) or [Infura](https://www.infura.io/).
