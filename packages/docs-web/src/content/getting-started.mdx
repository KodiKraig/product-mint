...
Mint the Organization NFT to represent your organization. Get the Organization NFT contract address from [contract addresses](/contracts/deployed-addresses) for the network you are using.
...
<Callout>
    We are in the process of building a customer minting and portal for organizations to provide their customers with a way to purchase their Product Pass NFTs and manage their subscriptions. This will be available in the near future!
</Callout>
...
While it is significantly easier to use ProductMint than using a traditional payment processor API, it is still a bit of work. If you are looking for an easier way to get started, don't forget to check out the [dashboard](https://dashboard.productmint.io).