...
- ⚡ **Permissionless renewals** - Automatic billing that never stops
...
- **Recurring subscription products with permissionless renewals**
    ...
    - **Tiered**: Quantity based, paid at start of billing cycle similar to "seats" for SaaS products.
    - **Usage**: Metered and paid at the end of billing cycle. Useful for products that are metered like data usage, API calls, AI tokens, etc.
...
Want to charge 10 USDC per month but be paid in a volatile token like WETH? We have you covered.

Learn more about dynamic tokens [here](./contracts/dynamic-tokens).
...
### Organization NFT
- Represents your organization allowing you to create and manage products.
